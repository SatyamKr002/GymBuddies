          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16 overflow-x-hidden">
            ...
            className="relative h-64 overflow-hidden rounded-lg sm:h-80 lg:order-last lg:h-full">
              <img
                ...
                src="https://images.unsplash.com/photo-1546817372-628669db4655?q=80&w=2071&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            ...
            className="lg:py-24">
              <h2 className="text-6xl font-bold sm:text-6xl text-center">
                ...
                <div className="mb-8">Healthier You! </div>
              </h2>
